...
<head>
    ...
    <title>E-KURSUS - Input Mata Pelajaran</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Input Mata Pelajaran </h1>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-7">
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto" method="POST" action="cek_input_mapel.php">
                                <br> 
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Nama Mata Pelajaran : </i>
                                        <input type="text" placeholder="Nama Mata Pelajaran" name="nama_mapel" class="form-control form-control-user" pattern="{3,25}" required>
                                    </div> 
                                <br>
