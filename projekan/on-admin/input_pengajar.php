...
<head>
    ...
    <title>E-KURSUS - Edit Data Pengajar</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="input_pengajar.php"> Input Pengajar </a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Input Data Pengajar </h1>
                    </div>

                <div class="row">
                    <div class="col-xl-12 col-lg-7">
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto" method="POST" action="cek_input_pengajar.php">
                                <br> 
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Nama Pengajar : </i>
                                        <input type="text" placeholder="Nama Pengajar" name="nama_pengajar" class="form-control form-control-user" pattern="[a-z]{3,25}" required>
                                    </div> 
                                <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> NIK : </i>
                                        <input type="text" placeholder="NIK" name="nik" class="form-control form-control-user" pattern="[0-9]{16,16}" required>
                                    </div> 
                                <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Alamat : </i>
                                        <input type="text" placeholder="Alamat" class="form-control form-control-user" name="alamat" required>
                                    </div>
                                <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Nomor Telepon : </i>
                                        <input type="text" placeholder="Nomor Telepon" id="nomor_telepon" name="nomor_telepon" class="form-control form-control-user" required>
                                    </div>  
                                <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <i> Jenis Kelamin : </i>
