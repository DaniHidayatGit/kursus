...
<head>
    ...
    <title>E-KURSUS - Edit Data Mata Pelajaran</title>
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="daftar_mapel.php"> Daftar Mata Pelajaran </a>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-7">
                        <div class="card shadow mb-5">
                            <form class="user col-md-auto" method="POST" action="cek_edit_mapel.php">
                                <br>
                                    <div class="col-xl-5 col-lg-7">
                                        <input type="hidden" value="<?= $row['kode_mata_pelajaran']; ?>" placeholder="Nama Mata Pelajaran" name="kode_mata_pelajaran" class="form-control form-control-user" required>
                                        <i> Nama Mata Pelajaran : </i>
                                        <input type="text" value="<?= $row['nama_mata_pelajaran']; ?>" placeholder="Nama Mata Pelajaran" name="nama_mata_pelajaran" class="form-control form-control-user" required>
                                    </div>
                                <br>  
