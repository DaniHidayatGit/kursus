                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-5">
                                <div class="col-md-auto">
                                    ...
                                    <br>
                                    <h5 align="justify">
                                        E-KURSUS adalah sebuah aplikasi yg berbasis web yang menyediakan untuk kursus atau pembelajaran bahasa Inggris dengan mempermudah kita untuk belajar Bahasa Inggris.
                                    </h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-5">
                                <div class="col-md-auto">
                                    <br>
                                    <h4 align="center">
                                        Kelebihan E-KURSUS itu apa sih?
                                    </h4>
                                    <br>
                                    <h5 align="justify">
                                        Jadi kelebihan dari E-KURSUS itu, kita tidak perlu pergi ke tempat bimbel, dan dari E-KURSUS sudah menyediakan tempat untuk belajar Bahasa Inggris melalui Onine dengan pengajar yang ahli dan handal.
                                    </h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-5">
                                <div class="col-md-auto">
                                    <br>
                                    <h4 align="center">
                                        Keuntungan E-KURSUS itu apa sih?
                                    </h4>
                                    <br>
                                    <h5 align="justify">
                                        Jadi keuntungan dari E-KURSUS itu kita bisa mendapatkan pembelajaran yang menarik melalui online dengan pembelajaran yang santai namun sambil mendapatkan ilmu dalam berbahasa Inggris.
                                    </h5>
                                    <br>
                                    <br>
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-5">
                                <div class="col-md-auto">
                                    <br>
                                    <h4 align="center">
                                        Bagaimana sih cara kami yang ingin Mendaftar?
                                    </h4>
                                    <br>
                                    <h5 align="justify">
                                        Nah jika kalian ingin mendaftar, kalian bisa langsung mendaftar dengan paket pilihan yang telah kami sediakan didalam web ini teman-teman, jadi ga perlu repot repot tinggal mendaftar dengan paket yang telah kami sediakan saja teman-teman.
                                    </h5>
                                </div>    
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-5">
                                <div class="col-md-auto">
                                    ...
                                    <br>
                                    <h5 align="justify">
                                        Nah pilihan paketnya terbagi menjadi nih menjadi 4, yang pertama itu ada yang 3 bulan, yang kedua ada yang 6 bulan, yang ketiga ada yang 9 bulan, dan yang terakhir ada yang 12 bulan atau satu tahun nih teman teman.
                                    </h5>
                                    <br> <br>
                                </div>    
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-5">
                                <div class="col-md-auto">
                                    <br>
                                    <h4 align="center">
                                        Bagaimana dengan harga pilihan paketnya?
                                    </h4>
                                    <br>
                                    <h5 align="justify">
                                        Nah dengan harga itu sesuai dengan pilihan teman-teman ambil, tetapi harganya sangat terjangkau dan murah teman-teman. Dan harga nya sudah kami sediakan dengan cukup sekali bayar saja teman-teman. Jadi sekali bayar teman-teman sudah dapat belajar dan dengan masa aktif yang teman-teman pilih. 
                                    </h5>
                                </div>
                            </div>
                        </div>
