            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Pilihan Paket Belajar </h1>
                    </div>

                    <!-- Content Row -->
                    <form method="POST" action="mendaftar.php" class="row">
                        <!-- Area Chart -->
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-4">
                                <input type="submit" class="btn btn-danger btn-block" name="3b" value="3 Bulan" onclick="pergi()">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-4">
                                <input type="submit" class="btn btn-danger btn-block" name="6b" value="6 Bulan" onclick="pergi()">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-4">
                                <input type="submit" class="btn btn-danger btn-block" value="9 Bulan" name="9b" onclick="pergi()">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-7">
                            <div class="card shadow mb-4">
                                <input type="submit" class="btn btn-danger btn-block" value="12 Bulan" name="12b" onclick="pergi()">
                            </div>
                        </div>
                    </form>
