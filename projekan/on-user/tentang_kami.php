        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="tentang_kami.php"> Tentang Kami </a>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-5">
                                <div class="col-md-auto">
                                    ...
                                    <br>
                                    <p align="justify" > Aplikasi ini dibuat Untuk mempermudah kita dalam belajar Bahasa Inggris. 
                                    Dan dengan adanya aplikasi ini sebagai jembatan antara pengajar dengan teman-teman. 
                                    Pembalajarn disini memfokuskan ke dalam Speaking, Pronoun, Vocab, dan semua tentang bahasa inggris. 
                                    Dalam 1 bulan terdapat 1 mata pelajaran yang bisa di ikuti, Kenapa? karena untuk memperdalam dengan memfokuskan dalam satu hal agar ilmunya dapat dan tersampaikan kepada teman-teman semuanya.
                                    sistem belajarnya itu tergantung kepada pengajar yg telah disediakan, apakah pakai aplikasi yang bisa untuk meet atau dengan whatsapp, itu tergantung dan diskusi dengan masing-masing pengajarnya.
                                    Teman-teman bisa mencetak hasil perkembangan teman-teman setiap bulannya, di bagian daftar nilai yang bisa dijadikan evaluasi diri untuk teman-teman.
                                    Jika teman-teman ingin bertanya atau ingin menyampaikan kritik dan saran silahkan menuju menu "Contact Us". 
                                    Kami akan merespon atau membalas secepat mungkin demi kenyamanan kita bersama.
                                    </p>
                                    <br>
                                    <p align="center"> Saya berharap semoga aplikasi ini dapat bermanfaat bagi pengajar dan teman-teman sekalian semuanya:) </p>
                                    <p align="center"> Saya Ucapkan Terima Kasih:) </p>
                                </div>
                            </div>
                        </div>
                    </div>
