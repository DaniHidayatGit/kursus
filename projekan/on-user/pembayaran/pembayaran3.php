                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <form class="card shadow mb-4" method="POST" action="cek_pembayaran3.php" enctype="multipart/form-data" runat="server">
                                <br>
                                <div class="col-md-auto">
                                    ...
                                    <br>
                                    <i> Harga Paket 3 Bulan Adalah Senilai : Rp.4.400.000 </i>
                                </div>
                                <br>
