<?php
    ...
    if ($check_user->fetch()) {
        $rows = array('foto_profil'=>$foto_profil, 'jenis_kelamin'=>$jenis_kelamin, 'nomor_telepon'=>$nomor_telepon, 'masa_aktiif'=>$masa_aktif);
    }
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <form class="card shadow mb-4" method="POST" action="cek_pembayaran4.php" enctype="multipart/form-data" runat="server">
                                <br>
